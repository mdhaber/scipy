...
class Uniform(ContinuousDistribution):
    ...
    _a_param = _RealParameter('a', domain=_a_domain, typical=(1e-1, 0.9))
    _b_param = _RealParameter('b', domain=_b_domain, typical=(1.1, 10))
    _x_param = _RealParameter('x', domain=_x_support, typical=('a', 'b'))
    ...
    # Wouldn't agree with generic methods and therefore would
    # fail tests.
